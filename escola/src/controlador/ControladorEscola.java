...
public class ControladorEscola {
    ...
    public static void inserir(ManutencaoEscola man){
        ...
        objeto.setNr_funicionarios(Integer.parseInt(man.jtfNR_Funcionarios.getText()));
...
man.dispose();//fechar a tela da manutenção
     ...
     public static void atualizarTabela(JTable tabela) {
        ...
        modelo.addColumn("Numero de Funconarios");
        ...
        for (Escola objeto : resultados) {
            ...
            linha.add(objeto.getNr_funicionarios());
            linha.add(objeto.getNr_alunos());
            linha.add(objeto.getArea());
            linha.add(objeto.getAbertura());
     ...
     public static void atualizaCampos(ManutencaoEscola man, int pk){ 
        ...
        man.jtfNR_Funcionarios.setText(objeto.getNr_funicionarios().toString());
